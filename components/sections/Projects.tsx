  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setImageIndices((prev) => ({
        ...prev,
        [hoveredProjectId]:
          ((prev[hoveredProjectId] ?? 1) + 1) % project.images.length,
      }));
    }, 2000);
    ...
    <section id="projects" className="relative z-10 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="Installed indoor golf environments for Golf Saudi, resorts, and private residences — the proof behind Marafei Golf as a GCC installer."
        />
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative block aspect-4/5 overflow-hidden rounded-2xl border border-border/20 text-left transition-all duration-300 hover:border-primary/20 hover:shadow-soft"
                >
